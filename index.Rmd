...
I want to make a quick note about something. Few things I write about in this book are original. I heavily relied on the default R documentation^[@R-base], as well as many other package-specific documentation pages, to write this book. (See **References** page for complete list of sources.)
...
The other key difference is the depth of the content. This book is *not* a reference book. It's about teaching the core concepts of R programming that come up again and again. Understanding this foundation will make it easier for you to use reference materials later. 
