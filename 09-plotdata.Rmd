...
```{r 9, echo=FALSE, out.width='70%',fig.align='center'}
cars <- cars
...
```{r 9.1, echo=FALSE, out.width='70%',fig.align='center'}
library(ggplot2)
...
```{r 9.2, echo=FALSE,message=FALSE, out.width='70%',fig.align='center'}
library(plotly)
...
```{r 9.3, out.width='70%',fig.align='center'}
...
```{r 9.4, out.width='70%',fig.align='center'}
library(ggplot2)
bond <- read.csv("https://raw.githubusercontent.com/taylorrodgers/bond/main/bond.csv")
bond$actor <- factor(bond$actor)
...
```{r 9.5, out.width='70%',fig.align='center'}
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
   labs(x="Year",
...
```{r 9.6, out.width='70%',fig.align='center'}
library(ggthemes)
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
...
```{r 9.7, out.width='70%',fig.align='center'}
library(ggthemes)
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
...
Here's an example:
```{r 9.8,warning=FALSE,message=FALSE, out.width='70%',fig.align='center'}
library(plotly)
...
```{r 9.9,warning=FALSE,message=FALSE, out.width='70%',fig.align='center'}
library(plotly)
plot_ly(data=bond,x=~year,y=~gross,color=~actor,size=10) %>%
...
```{r 9.10, eval=FALSE, out.width='70%',fig.align='center'}
...
```{r 9.11, echo=FALSE, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross,color=actor))
```
...
```{r 9.12, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross,color=actor)) +
   geom_point()
```
...
```{r 9.13, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross,color=actor)) +
   geom_line()
```
...
```{r 9.14, out.width='70%',fig.align='center'}
...
```{r 9.15, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross)) +
   geom_line() +
...
```{r 9.15.1, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross)) +
   geom_line() +
...
```{r 9.16, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross)) +
   geom_point(aes(color=actor),size=3) +
   geom_line()
```
...
```{r 9.17, eval=FALSE, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3)
```
...
```{r 9.18, out.width='70%',fig.align='center'}
...
```{r 9.19, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=actor)) +
...
```{r 9.20, out.width='70%',fig.align='center'}
...
```{r 9.21, out.width='70%',fig.align='center'}
...
```{r 9.22, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=year,y=gross)) +
   geom_line()
```
...
```{r 9.24, out.width='70%',fig.align='center'}
ggplot(data=bond,mapping=aes(x=actor,y=gross)) +
   geom_boxplot()
```
...
```{r 9.25, out.width='70%',fig.align='center'}
library(ggthemes)
ggplot(data=bond,
...
```{r 9.26, out.width='70%',fig.align='center'}
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
   labs(x="Year",
...
```{r 9.27, out.width='70%',fig.align='center'}
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
   labs(x="Year",
...
```{r 9.28, out.width='70%',fig.align='center'}
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
   labs(x="Year",
...
```{r 9.29, out.width='70%',fig.align='center'}
library(ggthemes)
ggplot(data=bond,
       mapping=aes(x=year,y=gross,color=actor)) +
   geom_point(size=3) +
