# How to Filter and Transform Data in Base R {#baserfilter}
...
```{r 3.15.1, echo=FALSE,fig.align="center",out.width="50%%"}
knitr::include_graphics("1.29_Arrays_Flat.png",dpi=150)
```

And then stacks them into an array:

```{r 3.15.2, echo=FALSE,fig.align="center",out.width="15%"}
knitr::include_graphics("1.30_Arrays_Stacked.png",dpi=150)
```
...
```{r 3.16.1, echo=FALSE,fig.align="center",out.width="50%"}
knitr::include_graphics("1.35_Arrays_Highlight_1.png",dpi=150)
```
...
```{r 3.16.2, echo=FALSE,fig.align="center",out.width="50%"}
knitr::include_graphics("1.36.1_Array_Row_Selection.png",dpi=150)
```

And R then pivots and places those rows into a new array, with each column representing the level of the array...

```{r 3.16.3, echo=FALSE,fig.align="center",out.width="65%"}
knitr::include_graphics("1.36.2_Array_Row_Selection.png",dpi=150)
```
...
```{r 3.18.1, echo=FALSE,fig.align="center",out.width="70%"}
knitr::include_graphics("1.37.1_Array_Column_Selection.png",dpi=150)
```
...
Now, you'll notice that I intentionally kept this as a data frame object type. Had I used the `bond$year` notation, it would've turned it into a vector. This would've made further filtering later more difficult.
...
q1 <- seq(1,20,2)
```
2. Filter the following vector to values between 19 and 20, but only for the first three entries that meet that criteria. (Hint: add `[n:n]` for the range of values after you determine which values meet that criteria)
