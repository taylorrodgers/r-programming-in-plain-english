...
Take this code below and run it. You’ll see that we make individual vectors containing data on James Bond movies^[@noauthor_james_nodate] and then combine it into a data frame.
